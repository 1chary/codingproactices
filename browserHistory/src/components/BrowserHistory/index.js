...
class BrowserHistory extends Component {
  state = {textEntered: '', historyList: initialHistoryList}
  ...
  deleteItem = id => {
    ...
    this.setState({historyList: removedList})
  }
  ...
  render() {
    ...
    const filteredList = historyList.filter(eachList =>
      eachList.title.toLowerCase().includes(textEntered.toLowerCase()),
    )
